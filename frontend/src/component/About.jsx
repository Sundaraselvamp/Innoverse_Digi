...
import heroImage from "../images/about2.webp"; // Replace with your hero image
  ...
  return (
    <div>
      ...
      <div className="mission-vision-wrapper">
        <div className="mission-vision-content mission">
          <h2>Our Mission</h2>
          <p>
            To empower businesses in Tamil Nadu and beyond with seamless, stress-free digital marketing and IT development solutions, driving growth, innovation, and lasting success.
          </p>
        </div>
        <div className="mission-vision-content vision">
          <h2>Our Vision</h2>
          <p>
            To be recognized as the most reliable partner for businesses, offering unparalleled value and transforming marketing into a worry-free experience.
          </p>
        </div>
      </div>
      ...
      <section className="about-section">
        ...
        <p>
          Let us take the stress out of marketing so you can focus on building
          the business of your dreams. Contact us today and let’s grow together!
        </p>
      </section>
      <div className="wd_end">
        <p>
          Let us help you transform your online presence and achieve real,
          measurable results with solutions that are as unique as your business.
        </p>
